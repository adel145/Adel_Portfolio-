...
const certificates = [
  ...
  },
  {
    ...
    college: "Udemy",
    description:
      "Practical training focused on building AI-powered applications, integrating LLM APIs, and designing useful AI workflows.",
    tags: [
